...
if bt_4:
    ...
    st.write("Analytic FORK is a analytical tool initially designed to analyse energy and water consumption figure of a manufacturing industries and similar companies at each stage of manufacturing and forcast the values for the same.")
...
if bt_5:
    ...
    st.image("./step2(a)(b).png")
    st.image("./step2(c).png")
